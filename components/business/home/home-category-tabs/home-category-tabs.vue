...
const list = ref([
    ...
    { id: '3', name: t('home_008'), icon: '/static/images/tabs/3.png', activeIcon: '/static/images/tabs/3-orange.png', iconWidth: 66, iconHeight: 66, marginTop: 8, marginRight: -4 },
    { id: '4', name: t('home_009'), icon: '/static/images/tabs/4.png', activeIcon: '/static/images/tabs/4-orange.png', iconWidth: 36, iconHeight: 36 },
    { id: '5', name: t('home_010'), icon: '/static/images/tabs/5.png', activeIcon: '/static/images/tabs/5-orange.png', iconWidth: 34, iconHeight: 26 }
])
