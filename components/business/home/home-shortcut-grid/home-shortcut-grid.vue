<template>
	<view class="custom-nav" v-if="list.length > 0">
		<view class="nav-item" v-for="(item, index) in list" :key="index" hover-class="nav-item--hover"
			:hover-stay-time="100" @click="handleTap(item, index)">
			<view class="icon-wrap">
				<image class="icon-image" :src="item.icon || item.image" mode="aspectFit" :style="{
